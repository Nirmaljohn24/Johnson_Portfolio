...
import aboutImg from "../../assets/projects/aboutimgdark.png";
import aboutImglight from "../../assets/projects/aboutimg.jpg";
...
const About = ({ theme }) => {
    ...
    const stats = [
  { label: "2.9+ Year's", description: "Experience" },
    ...
    <section id="about" className="lg:min-h-screen ">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-16  py-12  md:px-[100px] px-1  ">
        ...
        <div className="max-w-4xl text-center md:text-left">
          ...
          >
            I am Johnson Dravid and I'm a MERN STACK Developer
          </h1>
          ...
          <motion.a
            variants={ChildVariants}
            href="/BJohnsonDravid_MERNResume_.pdf"
            target="_blank"
            download
