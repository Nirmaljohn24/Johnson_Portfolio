          ...
          <div className="w-full lg:w-1/2 px-7">
            ...
            >
              ...
              <div className=" mb-[40px] flex items-center justify-center gap-4 text-2xl md:text-4xl sm:gap-7">
                <a
                  href="https://www.linkedin.com/in/johnson-dravid/"
                  target="_blank"
                ...
                <a
                  href="https://github.com/Nirmaljohn24"
                  target="_blank"
                  className={` ${
                    theme === "dark" ? "text-white" : "text-black"
                  } `}
                ...
                <a
                  href="https://wa.me/9486982057?text=Hello%20there!%20I%20have%20a%20question%20for%20you."
                  target="_blank"
